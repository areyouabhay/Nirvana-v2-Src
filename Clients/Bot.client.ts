import { ClientOptions, Collection, GatewayIntentBits, EmbedBuilder, RESTPostAPIChatInputApplicationCommandsJSONBody, IntentsBitField, ColorResolvable } from 'discord.js';
